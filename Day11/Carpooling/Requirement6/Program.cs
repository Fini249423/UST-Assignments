...
using static Requirement2.MemberCar;
...
namespace Requirement6
{
...

    {
      ...
      new MemberCar { Id = 1,/* memberr = 1,carr = 2,*/ carRegistrationNumber = "TN66AB4214", carColor = "brown" },

      new MemberCar { Id = 2,/* memberr = 1*/ carRegistrationNumber = "TN38BR9689", carColor = "white" },

      new MemberCar { Id = 3, /*memberr = 4*/ carRegistrationNumber = "TN61EB4004", carColor = "white" }
...

            {
...

                {
                    ...
                    memberCarsWithColor[i].Id = int.Parse(input[1]);
